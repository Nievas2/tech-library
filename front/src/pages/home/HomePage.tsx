...
const HomePage = () => {
  ...
  const cardsData = [
    ...
    {
      "title": "SQL",
      "description": "Un lenguaje de consulta para interactuar con bases de datos",
    ...
    {
      "title": "PostgreSQL",
      "description": "Un sistema de base de datos relacional para almacenar y recuperar datos",
    ...
    {
      "title": "Docker",
      "description": "Un sistema de contenedores para ejecutar aplicaciones de manera aislada",
    ...
    {
      "title": "Kubernetes",
      "description": "Un sistema de orquestación de contenedores para gestionar aplicaciones",
      "tags": ["Containerization", "DevOps", "Cloud"],
      "createdBy": "Laura Lee",
      "tagColors": tagColors,
    },
  ...
  return (
    <>
      <h1>SerachBar</h1>
      <CardsContainer cards={cardsData} tagColors={tagColors} />
    </>
  )
}
