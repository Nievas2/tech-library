...
const SkeletonCard = () => {
  return (
    <div className="flex w-[268px] cp:w-[328px] sm:w-[294px] md:w-[358px] lg:w-[366px] xl:w-[322.66px] h-[250px] bg-main/15 flex-col justify-between gap-6 rounded-md shadow-xl p-4">
