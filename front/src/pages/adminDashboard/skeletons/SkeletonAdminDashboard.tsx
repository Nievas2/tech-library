...
const SkeletonsAdminDashboard = () => {
  return (
    <div className="flex bg-main/15 flex-col justify-between rounded-md shadow-xl p-4 min-w-[300px] sm:min-w-[300px] md:min-w-[358px] lg:min-w-[320px] xl:min-w-[400px] h-[241.3px]">
