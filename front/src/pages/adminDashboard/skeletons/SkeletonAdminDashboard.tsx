...
const SkeletonsAdminDashboard = () => {
  return (
    <div className="flex bg-main/15 flex-col justify-between border border-dark dark:border-light rounded-md shadow-xl p-4 w-[328px] sm:w-[294px] md:w-[358px] lg:w-[237.33px] xl:w-[322.66px] h-[250px]">
